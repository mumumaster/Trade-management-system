...
<%@include file="/WEB-INF/jsp/common/header.jsp"%>
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-5">
				<form class="form-inline" id="cha" method="get">
					<span class="form-group"> <label for="proname">客户公司名称:</label> 
	...
	<!-- 解析并显示员工数据 -->
	<%@include file="provider/proInfo.jsp"%>
	<!-- 解析并显示分页信息 -->
	<%@include file="pageInfo/build_page_info.jsp"%>
	<!-- 解析显示分页条数据 -->
	<%@include file="pageInfo/build_page_nav.jsp"%>
	<!-- 学生添加的模态框 -->
	<%@include file="provider/add_info.jsp"%>
	<!-- 学生修改的模态框  -->
	<%@include file="provider/modify_info.jsp"%>
	<!-- 学生删除的模态框  -->
	<%@include file="provider/delete_info.jsp"%>
