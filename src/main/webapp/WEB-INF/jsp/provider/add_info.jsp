      ...
      <div class="modal-body">
        <form class="form-horizontal" method="post">
          <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="procode" class="form-control" id="usercode_add_input" placeholder="">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="proname" class="form-control" id="proName_add_input" placeholder="">
		      <span class="help-block"></span>
		    </div>
		  </div>
		    <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="prophone" class="form-control" id="proPhone_add_input" placeholder="">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="col-sm-2 control-label">联系：</label>
		    <div class="col-sm-10">
		      <input type="text" name="procontact" class="form-control" id="proContact_add_input" placeholder="">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="proaddress" class="form-control" id="proAddress_add_input" placeholder="详细地址">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="profax" class="form-control" id="proFax_add_input" placeholder="">
		      <span class="help-block"></span>
		    </div>
		  </div>
		</form>
...
<script type="text/javascript">
	...
	$("#stu_save_btn").click(function(){
		...
		//3、发送ajax请求保存员工
		$.ajax({
			url:"${APP_PATH}/sys/provider/addShow",
			type:"POST",
